namespace MaxiKiosco
{
    partial class Inicio : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            menutitulo.Items.AddRange(new ToolStripItem[] { titulo, lblusuario });
            menutitulo.Location = new Point(0, 0);
            menutitulo.Name = "menutitulo";
            menutitulo.Padding = new Padding(8, 3, 0, 3);
            menutitulo.RightToLeft = RightToLeft.No;
            menutitulo.Size = new Size(1400, 95);
            ...
            lblusuario.Size = new Size(203, 89);
            lblusuario.Text = "toolStripMenuItem1";
            // 
            // contenedor
            // 
            ...
            contenedor.Size = new Size(1400, 725);
