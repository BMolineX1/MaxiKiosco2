...
namespace MaxiKiosco
{
    public partial class frmCategoria : Form
    {
        ...
        public frmCategoria()
        {
            ...
            // ✅ CONECTAR EVENTO DE CLIC EN CONTENIDO DE CELDA (para seleccionar registro)
            // dgvdata.CellContentClick += dgvdata_CellContentClick;
            // ✅ CONECTAR EVENTO DE PINTADO DE CELDA (para mostrar el check)
            dgvdata.CellPainting += dgvdata_CellPainting_1; // Aseguramos que también esté
            // ✅ NUEVA CONEXIÓN: Evitar que la celda de selección entre en modo edición
        ...
        private void frmCategoria_Load(object sender, EventArgs e)
        {
            ...
            // ✅ CÓDIGO CORREGIDO: Usamos DataGridViewTextBoxColumn para que CellPainting funcione sin conflicto
        ...
        {
            // Si la columna es la de selección (índice 0)
            if (e.ColumnIndex == 0)
            {
                // Cancelar la edición
                e.Cancel = true;
        ...
        private void txtbusqueda_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                // 🚨 CORRECCIÓN CLAVE: Mostrar todas las filas si el campo de búsqueda está vacío.
                foreach (DataGridViewRow row in dgvdata.Rows)
                {
                    row.Visible = true;
                }
