...
INSERT INTO `cliente` VALUES (1,'Federico','Molina','38962453',NULL,'3644657148','mz 7 pc 12 Barrio Pro.Mu.Vi','fede.099molina@gmail.com',1),(4,'gabi','Vera','2333333333',NULL,'33333333','mz 7 pc 23','fede@gmail.com',0),(5,'Elias','Ramirez','42746919',NULL,'3644222298','Barrio anbtocÃ±','elias@gmail.com',1);
...
BEGIN
    ...
    ELSE
        SET mensaje = 'No se encontrÃ³ el cliente o no hubo cambios';
    END IF;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
