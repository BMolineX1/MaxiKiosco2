...
namespace CapaNegocio
{
    public class CN_Cliente
    {
        ...
        //  NUEVO MÉTODO PARA EXPONER LA BÚSQUEDA A LA CAPA DE PRESENTACIÓN (frmVentas)
        public List<Cliente> BuscarClientes(string textoBusqueda)
        {
            // Llamamos al método que ya creaste en la Capa de Datos
            return objeto_cliente.BuscarClientes(textoBusqueda);
        }
