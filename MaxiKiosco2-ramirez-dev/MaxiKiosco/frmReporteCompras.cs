...
namespace MaxiKiosco
{
    public partial class frmReporteCompras : Form
    {
        ...
        private void RenderCompras(IEnumerable<ReporteCompra> listado)
        {
            ...
            {
                // ⚠️ Ajustá al ORDEN EXACTO de tu DGV
        ...
        private void iconButton2_Click(object sender, EventArgs e) => ApplyCompraFilter();
        // Si querés en tiempo real: descomentá
        // private void txtbusqueda_TextChanged(object sender, EventArgs e) => ApplyCompraFilter();
